...
Public num_rowCursor As Integer
Public num_colCursor As Integer
...
' ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
    ...
    For i = 1 To num_cntDate
        ...
        If Range("달력").Cells(i, 1).Value = Date Then
            num_rowCursor = num_row
            num_colCursor = num_colIdxDate + (i * 2 - 2)
        End If
    Next
...
' ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
    ...
    Cells(num_rowCursor, num_colCursor).Select
